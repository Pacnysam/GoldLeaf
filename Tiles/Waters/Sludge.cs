...
namespace GoldLeaf.Tiles.Waters
{
    ...
    public class SludgeWaterfall : ModWaterfallStyle
    {
    }

    public class SludgeSplash : ModDust
    {
    ...
    public class SludgeDrop : ModGore
	{
