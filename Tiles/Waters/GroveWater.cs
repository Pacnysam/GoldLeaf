...
namespace GoldLeaf.Tiles.Waters
{
    public class GroveWater : ModWaterStyle
    {
        public override bool ChooseWaterStyle()
        {
            World.BiomeManager modPlayer = Main.LocalPlayer.GetModPlayer<World.BiomeManager>();
            return modPlayer.ZoneGrove || modPlayer.FountainGrove;
        }

        public override int ChooseWaterfallStyle()
        {
            return mod.GetWaterfallStyleSlot<GroveWaterfall>();
        }

        public override int GetSplashDust()
        {
            return DustType<GroveSplash>();
        }

        public override int GetDropletGore()
        {
            return mod.GetGoreSlot<GroveWaterDrop>();
        }
    ...
    public class GroveWaterfall : ModWaterfallStyle
    {
    }

    public class GroveSplash : ModDust
    {
    ...
    public class GroveWaterDrop : ModGore
	{
