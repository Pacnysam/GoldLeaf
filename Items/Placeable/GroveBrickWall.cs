...
{
    public class GroveBrickWallT : ModWall
    {
    ...
    public class GroveBrickLeafWallT : ModWall
    {
        public override void SetDefaults()
        {
            Main.wallHouse[Type] = false;
    ...
    public class GroveBrickWall : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.createWall = WallType<GroveBrickWallT>();
            item.maxStack = 999;
        }
    }
}