...
namespace GoldLeaf.Items.Misc
{
    ...
    {
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(ConstellationDebuff.TagDamage);

        public override void SetDefaults()
        {
            Item.DefaultToWhip(ProjectileType<ConstellationP>(), 7, 1.2f, 3f, 45);
        ...
        public override void AddRecipes()
        {
            ...
            recipe2.AddIngredient(ItemID.SunplateBlock, 10);
    ...
    public class ConstellationP : ModProjectile
    {
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            Projectile.WhipSettings.RangeMultiplier += (0.16f * Main.player[Projectile.owner].GetModPlayer<ConstellationPlayer>().extraSegments);
        }
        ...
        {
            Player player = Main.player[Projectile.owner];
            target.AddBuff(BuffType<ConstellationDebuff>(), 180);
            ...
            if (player.GetModPlayer<ConstellationPlayer>().extraSegments < player.GetModPlayer<ConstellationPlayer>().maxExtraSegments)
            {
                ...
                DustHelper.DrawStar(target.Center, DustID.FireworkFountain_Blue, 5, target.scale * 3.8f, 1f, 0.7f, 1f, 0.5f, true, 0, 1);
            ...
            else Projectile.damage = (int)(Projectile.damage * 0.6f + (player.GetModPlayer<ConstellationPlayer>().extraSegments * 0.05f));
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D glowtex = Request<Texture2D>("GoldLeaf/Items/Misc/ConstellationPGlow").Value;
    ...
    public class ConstellationDebuff : ModBuff
    {
    ...
    public class ConstellationDebuffNPC : GlobalNPC
    {
        public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
        {
            ...
            if (npc.HasBuff<ConstellationDebuff>())
            {
                modifiers.FlatBonusDamage += ConstellationDebuff.TagDamage * projTagMultiplier;
            }
        }
    }
}
