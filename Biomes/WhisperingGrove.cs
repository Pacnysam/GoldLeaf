...
namespace GoldLeaf.Biomes
{
	public class WhisperingGroveSurface : ModBiome
	{
		...
		public override string BestiaryIcon => "GoldLeaf/Biomes/WhisperingGrove_Icon";
    ...
    {
        public override int ChooseFarTexture() => BackgroundTextureLoader.GetBackgroundSlot(Mod, "Goldleaf/Biomes/GroveBackgroundFar");
        public override int ChooseMiddleTexture() => BackgroundTextureLoader.GetBackgroundSlot(Mod, "Goldleaf/Biomes/GroveBackgroundMid");
        //public override int ChooseCloseTexture(ref float scale, ref double parallax, ref float a, ref float b) => BackgroundTextureLoader.GetBackgroundSlot(Mod, "Goldleaf/Biomes/GroveBackgroundNear");
